<style>
    ...
    :root {
        ...
        --semicondensed: 'Flama Semicondensed', sans-serif;
        ...
        --G: 1024px;
        --GG: 100%;
        --largura-celular: calc(100% - var(--filete));
    }
    ...
    :global(.subheadline-feature-block) {
    ...
    :global(.subheadline-feature-block h2) {
    ...
    :global(.content-wrapper.news-body.content) {
        padding: 0 !important;
    }
